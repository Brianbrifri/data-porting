...
public class SSOIDFetchUtility
{
   ...
   public void run(String excelFilePath, String outputFilePath) throws IOException
    {
        ...
        if (iterator != null) {
            while (iterator.hasNext()) {
                ...
                while (cellIterator.hasNext()) {
                    ...
                    //if the id index is -1 it means that the program has not come across the correct info
                    if (idIndex  == -1) {
                        //this means we have not come across the header for the data area yet
                    ...
                    //we are storing the data
                        ...
                        if (columnPosition == idIndex) {
                            ...
                            //this means that the id was a ssoid so add it to the set of them that needs to be put into a file
